...
WMSGenData = {
	...
	missionTypes: [{
			name: "Sauver le client.",
			mainType: 0,
			specialType: 0,
			clientIsTarget: true
		},
		{
			name: "Sauver la cible.",
			mainType: 1,
			specialType: 0
		},
		{
			name: "Escorter jusqu'à la cible.",
			mainType: 2,
			specialType: 0
		},

		{
			name: "Explorer avec le client",
			mainType: 3,
			clientIsTarget: true,
			subTypes: [{
					name: "Normal",
		...
		{
			name: "Prospecter avec le client.",
			mainType: 4,
			specialType: 0,
			useTargetItem: true,
			clientIsTarget: true
		...
		{
			name: "Prendre l'objet à la cible.",
			mainType: 9,
			useTargetItem: true,
			subTypes: [{
					name: "Normal",
...

		{
			...
			subTypes: [{
				...
				},
				{
					...
					specialType: 6,
					useTarget2: true,
					specialFloorFromList: "thievesden"
				},
				{
					name: "Maison de monstres",
					specialType: 7
				}
			]
		},
		...
		{
			name: "Arrêter la cible. (Magnézone)",
			advancedOnly: true,
			mainType: 10,
			forceClient: 504,
			subTypes: [{
...

		{
			...
			subTypes: [{
					...
					useTarget2: true,
					advancedOnly: true,
					specialFloorFromList: "challengerequest"
				},
				{
					name: "Mewtwo",
					specialType: 1,
		...
		{
			name: "Trouver le trésor.",
			mainType: 12,
			specialType: 0,
			forceClient: 422,
			forceTarget: 422,
			specialFloorFromList: "treasurehunt",
			noReward: true
		}
...
WMSGen = {
	...
	"fillItemLists": function() {
		var box1 = this.form.targetItemBox,
			box2 = this.form.rewardItemBox;
	...
	"fillMonsterLists": function() {
		var box1 = this.form.clientBox,
			box2 = this.form.targetBox,
			box3 = this.form.target2Box;
